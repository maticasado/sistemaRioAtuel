...
<head>
    <meta charset="UTF-8">
    <title>Filtrar por Programa</title>
    <link rel="stylesheet" href="../css/estilos.css">
</head>
<body>
<div class="container">
    <h2>Resultados: Programa "<?= htmlspecialchars($programa) ?>"</h2>
    ...
    <?php else: ?>
        <p>No se encontraron notebooks para este programa.</p>
    <?php endif; ?>
    <div class="actions">
